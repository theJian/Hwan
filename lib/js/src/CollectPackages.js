...
function collectPackages() {
  ...
  return $$Array.of_list(List.map(Js_option.getExn, List.filter(Js_option.isSome)(List.map(Package$Hwan.concretizePackage, $$Array.to_list(Glob.sync(Config$Hwan.packagePaths, {
                                  cwd: rootDir,
                                  absolute: /* true */1
                                }))))));
}
